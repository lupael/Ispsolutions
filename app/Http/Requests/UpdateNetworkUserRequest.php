    ...
    public function rules(): array
    {
        ...
        return [
            'username' => [
                ...
                'string',
                'max:255',
                Rule::unique('customers', 'username')->ignore($networkUserId),
            ],
            ...
            'ip_address' => [
                'nullable',
                'ip',
                Rule::unique('customers', 'ip_address')->ignore($networkUserId),
            ],
            'mac_address' => [
                'nullable',
                'string',
                'max:17',
                Rule::unique('customers', 'mac_address')->ignore($networkUserId),
            ],
