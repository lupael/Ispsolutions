...
<div class="container mx-auto px-4 sm:px-6 lg:px-8">
    <div class="mb-8 flex justify-between items-center">
        <div>
            ...
            <p class="mt-2 text-gray-600 dark:text-gray-400">Manage payment gateway integrations for your tenants</p>
        </div>
        <a href="{{ route('panel.super-admin.payment-gateway.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-lg">
            Add Gateway
        </a>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            ...
            <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">Provider: {{ $gateway->provider }}</p>
        ...
        <div class="col-span-full bg-white dark:bg-gray-800 rounded-lg shadow p-6 text-center">
            <p class="text-gray-600 dark:text-gray-400">No payment gateways configured. Add your first gateway to enable online payments.</p>
        </div>
        @endforelse
    </div>
</div>
