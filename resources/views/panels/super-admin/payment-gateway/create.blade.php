...
<div class="w-full px-4">
    <div class="mb-6">
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Add Payment Gateway</h1>
                <p class="mt-2 text-gray-600 dark:text-gray-400">Configure a new payment gateway</p>
            </div>
            <a href="{{ route('panel.super-admin.payment-gateway.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 transition">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
                <div class="p-6">
                    <form action="{{ route('panel.super-admin.payment-gateway.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            <label for="api_secret" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">API Secret <span class="text-red-500">*</span></label>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="url" class="w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('webhook_url') border-red-300 @enderror" 
                                   id="webhook_url" name="webhook_url" value="{{ old('webhook_url') }}" 
                                   placeholder="https://example.com/webhook">
                            @error('webhook_url')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                            <small class="text-xs text-gray-500 dark:text-gray-400">URL for payment notifications</small>
                        </div>
                        ...
                        <div class="flex justify-end space-x-3">
                            <a href="{{ route('panel.super-admin.payment-gateway.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 transition">Cancel</a>
        ...
        <div class="lg:col-span-1">
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
                <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                    <h5 class="text-base font-semibold text-gray-900 dark:text-gray-100">Gateway Information</h5>
                </div>
                <div class="p-6">
                    ...
                    <div class="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
                        <small class="text-sm text-yellow-800 dark:text-yellow-200 flex items-start">
