...
@section('title', 'ISP Clients (Admins)')

@section('content')
<div class="container mx-auto px-4 sm:px-6 lg:px-8">
    <div class="mb-8 flex justify-between items-center">
        <div>
            <h1 class="text-3xl font-bold text-gray-900 dark:text-white">ISP Clients (Admins)</h1>
            <p class="mt-2 text-gray-600 dark:text-gray-400">Manage your ISP client accounts</p>
        </div>
    </div>
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">{{ $admin->company ?? 'N/A' }}</td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                            {{ $admin->servicePackage->name ?? 'No Package' }}
                        </td>
                    ...
                    @empty
                    <tr>
                        <td colspan="6" class="px-6 py-4 text-center text-sm text-gray-500 dark:text-gray-400">No ISP clients found.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
