...
@section('title', 'All ISPs/Admins')

@section('content')
<div class="container mx-auto px-4 sm:px-6 lg:px-8">
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900 dark:text-white">All ISPs/Admins</h1>
        <p class="mt-2 text-gray-600 dark:text-gray-400">View all Admin (ISP) accounts across all tenants</p>
    </div>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    @empty
                    <tr>
                        <td colspan="6" class="px-6 py-4 text-center text-sm text-gray-500 dark:text-gray-400">No Admin accounts found.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
