        ...
        <div class="p-6">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="mt-2 text-gray-600 dark:text-gray-400">View and monitor customer data</p>
                </div>
            </div>
        </div>
    </div>
                        ...
                        @forelse($customers as $customer)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <a href="{{ route('panel.developer.customers.show', $customer->id) }}" class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-300">View Details</a>
                                </td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="7" class="px-6 py-12 text-center">
                                    ...
                                    <p class="text-sm text-gray-400 dark:text-gray-500">Customer data will appear here.</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
