                        ...
                        <tr>
                            <td colspan="5" class="px-6 py-4 text-center">
                                <div class="flex flex-col items-center justify-center py-8">
                                    ...
                                    <p class="text-gray-400 dark:text-gray-500 text-sm mt-2">Start earning commissions by managing your assigned customers.</p>
                                </div>
                            </td>
                        </tr>
                        @endforelse
        ...
        <div class="flex">
            ...
            <div class="ml-3">
                <p class="text-sm text-purple-700 dark:text-purple-300">
                    <strong>Commission Information:</strong> Commissions are calculated based on your assigned customer payments and subscriptions. 
                    Pending commissions will be processed during the next payment cycle. For any questions, please contact your operator.
                </p>
            </div>
        </div>
    </div>
