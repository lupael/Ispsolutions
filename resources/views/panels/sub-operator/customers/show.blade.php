        ...
        <div class="p-6">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                ...
                <div class="flex flex-wrap gap-2">
                    <a href="{{ route('panel.sub-operator.customers.index') }}" class="inline-flex items-center px-4 py-2 bg-white/20 hover:bg-white/30 border border-white/30 rounded-lg font-medium text-sm text-white transition">
