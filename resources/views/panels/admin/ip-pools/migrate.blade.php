                                ...
                                <ul class="list-disc pl-5 mt-2 space-y-1">
                                    @if($pools->isEmpty())
                                        <li>Create at least 2 IP pools in your network configuration
                                            <a href="{{ route('panel.admin.network.ipv4-pools.create') }}" class="underline font-semibold">Create IP Pool</a>
                                        </li>
                                    @endif
                                    @if($profiles->isEmpty())
                                        <li>Create PPPoE profiles on your routers
                                            <a href="{{ route('panel.admin.network.pppoe-profiles') }}" class="underline font-semibold">Manage PPPoE Profiles</a>
                                        </li>
                                    @endif
                                </ul>
                            </div>
