            ...
            <div class="bg-white rounded-lg shadow">
                <div class="px-6 py-4 border-b border-gray-200">
                    <div class="flex justify-between items-center">
                        ...
                        <div>
                            <a href="{{ route('panel.admin.packages.index') }}" class="px-3 py-1 text-sm px-4 py-2 rounded bg-gray-600 text-white hover:bg-gray-700">
                        ...
                        @else
                            ...
                            <div class="grid grid-cols-12 gap-4 mt-4">
                                <div class="col-span-12">
                                    ...
                                    <a href="{{ route('panel.admin.packages.index') }}" class="px-6 py-3 text-lg px-4 py-2 rounded bg-gray-600 text-white hover:bg-gray-700">
