                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-6 py-4 text-center text-sm text-gray-500 dark:text-gray-400">
                                    No mappings configured for this package. <a href="{{ route('panel.admin.packages.mappings.create', $package) }}" class="text-indigo-600 hover:text-indigo-900">Add your first mapping</a>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
