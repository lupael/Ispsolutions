<footer class="bg-white border-t border-gray-200 py-4 px-6">
    <div class="flex flex-col md:flex-row justify-between items-center text-sm text-gray-600">
        ...
        <div class="flex space-x-4 mt-2 md:mt-0">
            ...
            <span class="text-gray-400 cursor-not-allowed" title="Coming soon">Privacy Policy</span>
            {{-- TODO: Create Terms of Service page and route --}}
            <span class="text-gray-400 cursor-not-allowed" title="Coming soon">Terms of Service</span>
