...
<div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
    <div class="p-6">
        ...
        <form action="{{ route('panel.customers.wizard.store', ['step' => 2]) }}" method="POST" x-data="{ connectionType: '{{ old('connection_type', $data['connection_type'] ?? 'pppoe') }}' }">
            @csrf
            ...
            <div class="mt-8 flex justify-between">
                <a href="{{ route('panel.customers.wizard.step', ['step' => 1]) }}" class="inline-flex items-center px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700">
