...
<div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
    <div class="p-6">
        ...
        <form action="{{ route('panel.isp.customers.wizard.store', ['step' => 4]) }}" method="POST">
            @csrf
            ...
            <div class="mt-8 flex justify-between">
                <a href="{{ route('panel.isp.customers.wizard.step', ['step' => 3]) }}" class="inline-flex items-center px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700">
