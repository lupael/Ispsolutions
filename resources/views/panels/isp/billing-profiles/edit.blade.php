...
<div class="space-y-6">
    <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6">
        ...
        <form action="{{ route('panel.isp.billing-profiles.update', $billingProfile) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mt-6 flex justify-end space-x-3">
                <a href="{{ route('panel.isp.billing-profiles.index') }}" class="px-4 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-50">Cancel</a>
