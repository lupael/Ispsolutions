...
<div class="space-y-6">
    <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6">
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="space-x-3">
                <a href="{{ route('panel.isp.billing-profiles.edit', $billingProfile) }}" class="px-4 py-2 bg-indigo-600 text-white rounded-md text-sm">Edit</a>
                <a href="{{ route('panel.isp.billing-profiles.index') }}" class="px-4 py-2 border border-gray-300 rounded-md text-sm">Back</a>
            </div>
        </div>
