...
@section('title', 'Edit Operator Rate')
...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6">
            <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Edit Your Rate</h1>
            <p class="mt-2 text-gray-600 dark:text-gray-400">Update your pricing for {{ $masterPackage->name }}</p>
        </div>
    </div>
    ...
    <!-- Form -->
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <form action="{{ route('panel.isp.operator-packages.update', $operatorRate) }}" method="POST" class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <input type="number" name="operator_price" id="operator_price" value="{{ old('operator_price', $operatorRate->operator_price) }}" step="0.01" min="0" max="{{ $masterPackage->base_price }}" required class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                ...
                <div id="margin-info" class="p-4 rounded-md bg-blue-50 dark:bg-blue-900">
                ...
                <div class="flex items-center justify-end gap-4 pt-6 border-t border-gray-200 dark:border-gray-700">
                    <a href="{{ route('panel.isp.operator-packages.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-300 text-gray-700 rounded-md hover:bg-gray-400">
                        Cancel
                    </a>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateMargin() {
        const operatorPrice = parseFloat(priceInput.value) || 0;
    ...
    updateMargin(); // Initialize on page load
});
</script>
@endsection
