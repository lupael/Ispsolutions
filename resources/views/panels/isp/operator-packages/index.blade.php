                        ...
                        @forelse($operatorRates as $rate)
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm space-x-2">
                                    <a href="{{ route('panel.isp.operator-packages.edit', $rate) }}" class="text-blue-600 hover:text-blue-900">Edit</a>
                                    <form action="{{ route('panel.isp.operator-packages.destroy', $rate) }}" method="POST" class="inline delete-operator-rate-form">
                                        @csrf
                                        @method('DELETE')
                ...
                @foreach($masterPackages as $package)
                    ...
                    <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                        ...
                        <div class="mt-4">
                            ...
                            @else
                                <a href="{{ route('panel.isp.operator-packages.create', ['master_package_id' => $package->id]) }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 text-sm">
                                    Set Your Rate
                                </a>
                            @endif
                        </div>
