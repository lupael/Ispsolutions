        ...
        <div class="p-6">
            <div class="flex justify-between items-center">
                ...
                <div class="flex space-x-2">
                    <a href="{{ route('panel.isp.zones.edit', $zone) }}" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 transition">
                    ...
                    @foreach($zone->children as $childZone)
                        <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                            <div class="flex items-center justify-between">
                                ...
                                <a href="{{ route('panel.isp.zones.show', $childZone) }}" class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400">
                                    View
                                </a>
                            </div>
