...
<script nonce="{{ $cspNonce }}">
    ...
    document.getElementById('dateRangeForm').addEventListener('submit', function(e) {
        ...
        window.location.href = `{{ route('panel.isp.analytics.dashboard') }}?start_date=${startDate}&end_date=${endDate}`;
    });
    ...
    document.getElementById('exportAnalyticsBtn').addEventListener('click', function() {
        ...
        window.location.href = `{{ route('panel.isp.analytics.export') }}?${params.toString()}`;
    });
