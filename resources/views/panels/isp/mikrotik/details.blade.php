    ...
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 flex justify-between items-center">
            ...
            <div class="flex space-x-2">
                <a href="{{ route('panel.isp.mikrotik.monitor', $router->id) }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700">Live Monitor</a>
                <a href="{{ route('panel.isp.mikrotik.configure.show', $router->id) }}" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700">Configure</a>
                <a href="{{ route('panel.isp.network.routers.edit', $router->id) }}" class="inline-flex items-center px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700">Edit</a>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6">
            ...
            <div class="flex flex-wrap gap-3">
                <a href="{{ route('panel.isp.routers.import.index') }}" class="inline-flex items-center px-4 py-2 bg-blue-50 dark:bg-blue-900/30 rounded-md hover:bg-blue-100 dark:hover:bg-blue-900/50 text-blue-700 dark:text-blue-300">Import data</a>
                <a href="{{ route('panel.isp.routers.backup.index') }}" class="inline-flex items-center px-4 py-2 bg-green-50 dark:bg-green-900/30 rounded-md hover:bg-green-100 dark:hover:bg-green-900/50 text-green-700 dark:text-green-300">Backups</a>
                <a href="{{ route('panel.isp.nas.netwatch.index', $router->id) }}" class="inline-flex items-center px-4 py-2 bg-amber-50 dark:bg-amber-900/30 rounded-md hover:bg-amber-100 dark:hover:bg-amber-900/50 text-amber-700 dark:text-amber-300">RADIUS Netwatch</a>
            </div>
        </div>
    </div>
</div>
