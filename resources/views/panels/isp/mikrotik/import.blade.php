...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('import-pools-form').addEventListener('submit', function(e) {
        ...
        importData('{{ route('panel.isp.mikrotik.import.ip-pools') }}', formData, 'IP Pools');
    });
    ...
    document.getElementById('import-profiles-form').addEventListener('submit', function(e) {
        e.preventDefault();
        const formData = new FormData(this);
        importData('{{ route('panel.isp.mikrotik.import.profiles') }}', formData, 'PPP Profiles');
    });
    ...
    document.getElementById('import-secrets-form').addEventListener('submit', function(e) {
        e.preventDefault();
        const formData = new FormData(this);
        importData('{{ route('panel.isp.mikrotik.import.secrets') }}', formData, 'Customers');
    });
