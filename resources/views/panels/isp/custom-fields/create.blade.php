...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6">
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Create Custom Field</h1>
                    <p class="mt-2 text-gray-600 dark:text-gray-400">Add a new custom field to customer profiles</p>
                </div>
                <div>
                    <a href="{{ route('panel.isp.custom-fields.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition ease-in-out duration-150">
    ...
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6">
            <form action="{{ route('panel.isp.custom-fields.store') }}" method="POST" class="space-y-6" x-data="{ fieldType: '{{ old('type', 'text') }}' }">
                @csrf
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" required class="w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="e.g., tax_id">
                        ...
                        <div>
                            ...
                            <input type="text" name="label" id="label" value="{{ old('label') }}" required class="w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="e.g., Tax ID">
                        ...
                        <div>
                            ...
                            <input type="text" name="category" id="category" value="{{ old('category') }}" class="w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="e.g., Personal, Business">
                ...
                <div x-show="fieldType === 'select' || fieldType === 'checkbox'" class="border-t border-gray-200 dark:border-gray-700 pt-6">
                    ...
                    <div>
                        ...
                        <textarea name="options" id="options" rows="6" class="w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 font-mono text-sm">{{ old('options', '["Option 1", "Option 2", "Option 3"]') }}</textarea>
                ...
                <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center">
                            <input type="checkbox" name="required" id="required" value="1" {{ old('required') ? 'checked' : '' }} class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 dark:border-gray-700 rounded">
                ...
                <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                    ...
                    <div class="space-y-4">
                        ...
                        @foreach($roles as $slug => $name)
                            <div class="flex items-center">
                                <input type="checkbox" name="visibility[]" id="visibility_{{ $slug }}" value="{{ $slug }}" {{ in_array($slug, $oldVisibility) || empty($oldVisibility) ? 'checked' : '' }} class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 dark:border-gray-700 rounded">
                ...
                <div class="flex items-center justify-end space-x-3 pt-6 border-t border-gray-200 dark:border-gray-700">
                    <a href="{{ route('panel.isp.custom-fields.index') }}" class="inline-flex items-center px-4 py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md font-semibold text-xs text-gray-700 dark:text-gray-300 uppercase tracking-widest shadow-sm hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:opacity-25 transition ease-in-out duration-150">
                        Cancel
                    </a>
