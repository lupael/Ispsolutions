        ...
        <div class="p-6">
            <div class="flex justify-between items-center">
                ...
                <div class="flex space-x-3">
                    ...
                    <a href="{{ route('panel.isp.network.olt.create') }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <template x-for="olt in olts" :key="olt.id">
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                    <a :href="`/panel/isp/olt/${olt.id}/monitor`" class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400">Monitor</a>
