...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6">
            <form id="importForm" method="POST" action="{{ route('panel.isp.network-users.import.process') }}">
                @csrf
        ...
        <div class="flex">
            ...
            <div class="ml-3">
                ...
                <div class="mt-2 text-sm text-yellow-700 dark:text-yellow-300">
                    ...
                    <p class="mt-2">
                        <a href="{{ route('panel.isp.network.routers.create') }}" class="font-medium underline hover:text-yellow-600">
                            Add a router now
                        </a>
                    </p>
                </div>
