...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6">
            <form action="{{ route('panel.isp.sms.gateways.update', $gateway) }}" method="POST">
                @csrf
                @method('PUT')
