                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex justify-end space-x-2">
                                        @if(!$gateway->is_default)
                                            <form action="{{ route('panel.isp.sms.gateways.set-default', $gateway) }}" method="POST" class="inline">
                                                @csrf
                                        ...
                                        @endif
                                        <a href="{{ route('panel.isp.sms.gateways.edit', $gateway) }}" class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-300">Edit</a>
                                        <form action="{{ route('panel.isp.sms.gateways.destroy', $gateway) }}" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this gateway?');">
                                            @csrf
                                            @method('DELETE')
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="px-6 py-4 text-center text-sm text-gray-500 dark:text-gray-400">
                                    No SMS gateways configured yet. <a href="{{ route('panel.isp.sms.gateways.create') }}" class="text-indigo-600 hover:text-indigo-900">Add your first gateway</a>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
