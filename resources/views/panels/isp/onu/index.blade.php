...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6">
            <form method="GET" action="{{ route('panel.isp.network.onu.index') }}" class="space-y-4">
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-4">
                    ...
                    <div class="flex items-end">
                        ...
                        <a href="{{ route('panel.isp.network.onu.index') }}" class="ml-2 inline-flex items-center px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700">
                            Clear
                        </a>
                    </div>
                </div>
                        ...
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900 dark:text-gray-100">
                                    <a href="{{ route('panel.isp.network.onu.show', $onu) }}" class="hover:text-indigo-600 dark:hover:text-indigo-400">
                                        {{ $onu->serial_number }}
                                    </a>
                                </div>
                                @if($onu->name)
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                @if($onu->networkUser)
                                    <div class="text-sm text-gray-900 dark:text-gray-100">
                                        <a href="{{ route('panel.isp.customers.show', $onu->networkUser->id) }}" class="hover:text-indigo-600 dark:hover:text-indigo-400 hover:underline">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <a href="{{ route('panel.isp.network.onu.show', $onu) }}" class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-300 mr-3">View</a>
                                <a href="{{ route('panel.isp.network.onu.edit', $onu) }}" class="text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300">Edit</a>
                            </td>
                        </tr>
                        @empty
                        <tr>
