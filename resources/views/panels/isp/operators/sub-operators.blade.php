                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="flex space-x-2">
                                        <a href="{{ route('panel.isp.operators.profile', $supervisor->id) }}" class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-300 text-sm">View</a>
                                        <a href="{{ route('panel.isp.operators.edit', $supervisor->id) }}" class="text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300 text-sm">Edit</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                @foreach($supervisor->subordinates as $subordinate)
                                    <div class="border-l-2 border-indigo-300 dark:border-indigo-700 pl-4 py-2">
                                        <div class="flex items-center justify-between">
                                            ...
                                            <div class="flex space-x-2">
                                                <a href="{{ route('panel.isp.operators.profile', $subordinate->id) }}" class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-300 text-xs">View</a>
                                                <a href="{{ route('panel.isp.operators.edit', $subordinate->id) }}" class="text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300 text-xs">Edit</a>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
