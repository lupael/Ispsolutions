        ...
        <div class="p-6">
            <div class="flex justify-between items-center">
                ...
                <div class="flex gap-3">
                    ...
                    <a href="{{ route('panel.isp.network.ipv4-pools') }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700 transition">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
