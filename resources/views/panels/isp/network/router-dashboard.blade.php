            ...
            <div class="flex justify-between items-center">
                ...
                <div class="flex gap-3">
                    ...
                    @can('create', \App\Models\MikrotikRouter::class)
                        <a href="{{ route('panel.isp.network.routers.create') }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700 transition">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg hover:shadow-lg transition-shadow">
                <div class="p-6">
                    ...
                    <div class="flex gap-2 pt-4 border-t border-gray-200 dark:border-gray-700">
                        <a href="{{ route('panel.isp.network.routers.edit', $router->id) }}" class="flex-1 text-center px-3 py-2 bg-indigo-600 text-white text-xs font-semibold rounded hover:bg-indigo-700 transition">
                            Manage
                        </a>
                        @if($router->status === 'online')
