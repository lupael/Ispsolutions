...
<div class="space-y-6">
    ...
    <!-- Package Form -->
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <form action="{{ route('panel.isp.packages.store') }}" method="POST" class="p-6">
            @csrf
