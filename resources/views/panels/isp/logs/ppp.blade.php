...
@section('title', 'PPP Connection Logs')

@section('content')
<div class="space-y-6">
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6">
            <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100">PPP Connection Logs</h1>
            <p class="mt-2 text-gray-600 dark:text-gray-400">View PPP (PPPoE) connection and disconnection logs</p>
        </div>
    </div>
                        ...
                        @empty
                            <tr>
                                <td colspan="8" class="px-6 py-4 text-center text-sm text-gray-500 dark:text-gray-400">
                                    No PPP connection logs available
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
