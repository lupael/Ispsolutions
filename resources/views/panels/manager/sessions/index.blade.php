    ...
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6">
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Active Sessions</h1>
                    <p class="mt-2 text-gray-600 dark:text-gray-400">Monitor real-time user sessions and connections</p>
                </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-2xl font-semibold text-gray-900 dark:text-gray-100">{{ $stats['upload'] ?? '0 MB' }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-2xl font-semibold text-gray-900 dark:text-gray-100">{{ $stats['download'] ?? '0 MB' }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-2xl font-semibold text-gray-900 dark:text-gray-100">{{ $stats['avg_duration'] ?? '0h' }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                <div>
                    ...
                    <input type="text" placeholder="Search username or IP..." class="w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                </div>
                <div>
                    ...
                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        @forelse($sessions as $session)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900 dark:text-gray-100">{{ $session->ip_address }}</div>
                                    @if($session->mac_address)
                                        <div class="text-xs text-gray-500 dark:text-gray-400">{{ $session->mac_address }}</div>
                                    @endif
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <a href="#" class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-300 mr-3">Details</a>
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="px-6 py-12 text-center">
                                    ...
                                    <p class="mt-2 text-gray-500 dark:text-gray-400">No active sessions found.</p>
                                    <p class="text-sm text-gray-400 dark:text-gray-500">Sessions will appear here when users connect.</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
