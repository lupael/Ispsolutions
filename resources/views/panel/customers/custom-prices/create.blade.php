...
@section('title', 'Create Custom Price')
...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6">
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Create Custom Price</h1>
                    <p class="mt-2 text-gray-600 dark:text-gray-400">Set custom pricing for {{ $customer->full_name ?? $customer->username }}</p>
                </div>
                <div>
    ...
    <!-- Form -->
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <form action="{{ route('panel.customers.custom-prices.store', $customer) }}" method="POST" class="p-6">
            @csrf
