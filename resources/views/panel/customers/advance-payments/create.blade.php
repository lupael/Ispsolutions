...
@section('title', 'Record Advance Payment')
...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6">
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Record Advance Payment</h1>
                    <p class="mt-2 text-gray-600 dark:text-gray-400">Add advance payment for {{ $customer->full_name ?? $customer->username }}</p>
                </div>
                <div>
        ...
        <div class="flex">
            ...
            <div class="ml-3">
                <p class="text-sm text-blue-700 dark:text-blue-300">
                    Advance payments are prepayments that customers make ahead of service billing. The balance will be automatically applied to future invoices.
                </p>
            </div>
        </div>
    </div>
    ...
    <!-- Form -->
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <form action="{{ route('panel.customers.advance-payments.store', $customer) }}" method="POST" class="p-6">
            @csrf
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">Advance payment amount</p>
                    @error('amount')
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">Transaction ID, receipt number, or reference</p>
                ...
                <div class="lg:col-span-2">
                    ...
                    <p class="mt-1 text-sm text-gray-500">Additional notes about this advance payment</p>
                    @error('notes')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
