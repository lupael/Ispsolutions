...
// Super Admin Panel
Route::prefix('panel/super-admin')->name('panel.super-admin.')->middleware(['auth', 'resolve.tenant', 'subscription', 'role:super-admin'])->group(function () {
...
// Sales Manager Panel
Route::prefix('panel/sales-manager')->name('panel.sales-manager.')->middleware(['auth', 'resolve.tenant', 'subscription', 'role:sales-manager'])->group(function () {
...
// Manager Panel
Route::prefix('panel/manager')->name('panel.manager.')->middleware(['auth', 'resolve.tenant', 'subscription', 'role:manager'])->group(function () {
...
// Operator Panel
Route::prefix('panel/operator')->name('panel.operator.')->middleware(['auth', 'resolve.tenant', 'subscription', 'role:operator'])->group(function () {
...
// Sub-Operator Panel
Route::prefix('panel/sub-operator')->name('panel.sub-operator.')->middleware(['auth', 'resolve.tenant', 'subscription', 'role:sub-operator'])->group(function () {
...
// Accountant Panel
Route::prefix('panel/accountant')->name('panel.accountant.')->middleware(['auth', 'resolve.tenant', 'subscription', 'role:accountant'])->group(function () {
...
// Staff Panel
Route::prefix('panel/staff')->name('panel.staff.')->middleware(['auth', 'resolve.tenant', 'subscription', 'role:staff'])->group(function () {
...
Route::prefix('panel/card-distributor')->name('panel.card-distributor.')->middleware(['auth', 'resolve.tenant', 'subscription', 'role:card-distributor'])->group(function () {
...
// Customer Panel
Route::prefix('panel/customer')->name('panel.customer.')->middleware(['auth', 'resolve.tenant', 'subscription', 'is_customer'])->group(function () {
...
Route::prefix('panel/developer')->name('panel.developer.')->middleware(['auth', 'resolve.tenant', 'subscription', 'role:developer'])->group(function () {
